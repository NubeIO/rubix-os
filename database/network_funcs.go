...
func (d *GormDatabase) GetNetworkByPluginName(name string, args args.Args) (*model.Network, error) {
...
func (d *GormDatabase) GetNetworksByPluginName(name string, args args.Args) ([]*model.Network, error) {
...
func (d *GormDatabase) GetNetworkByPlugin(pluginUUID string, args args.Args) (*model.Network, error) {
	var networkModel *model.Network
	query := d.buildNetworkQuery(args)
...
func (d *GormDatabase) GetNetworksByPlugin(pluginUUID string, args args.Args) ([]*model.Network, error) {
	var networksModel []*model.Network
	query := d.buildNetworkQuery(args)
...
func (d *GormDatabase) GetNetworkByName(name string, args args.Args) (*model.Network, error) {
	var networksModel *model.Network
	query := d.buildNetworkQuery(args)
...
func (d *GormDatabase) GetNetworkByPoint(point *model.Point, args args.Args) (network *model.Network, err error) {
...
func (d *GormDatabase) GetNetworkByPointUUID(pntUUID string, args args.Args) (network *model.Network, err error) {
...
func (d *GormDatabase) GetNetworkByDeviceUUID(devUUID string, args args.Args) (network *model.Network, err error) {
...
func (d *GormDatabase) SetErrorsForAllDevicesOnNetwork(networkUUID string, message string, messageLevel string, messageCode string, doPoints bool) error {
	network, err := d.GetNetwork(networkUUID, args.Args{WithDevices: true, WithPoints: doPoints})
	if err != nil {
		return err
	}
...
func (d *GormDatabase) DeleteNetworkByName(name string, args args.Args) (bool, error) {
	var networksModel *model.Network
	query := d.buildNetworkQuery(args)
	if err := query.Where("name = ? ", name).First(&networksModel).Error; err != nil {
		return false, err
