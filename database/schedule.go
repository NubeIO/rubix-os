...
func (d *GormDatabase) GetSchedulesByArgs(args args.Args) ([]*model.Schedule, error) {
	var scheduleModel []*model.Schedule
...
func (d *GormDatabase) GetOneScheduleByArgs(args args.Args) (*model.Schedule, error) {
	var scheduleModel *model.Schedule
	query := d.buildScheduleQuery(args)
