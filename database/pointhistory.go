...
func (d *GormDatabase) GetPointHistories(args args.Args) ([]*model.PointHistory, error) {
...
func (d *GormDatabase) GetPointHistoriesByPointUUID(pUuid string, args args.Args) ([]*model.PointHistory, int64, error) {
	var count int64
	var historiesModel []*model.PointHistory
	query := d.buildPointHistoryQuery(args)
...
func (d *GormDatabase) GetPointHistoriesByPointUUIDs(pointUUIDs []string, args args.Args) ([]*model.PointHistory, error) {
	var historiesModel []*model.PointHistory
	query := d.buildPointHistoryQuery(args)
...
func (d *GormDatabase) GetPointHistoriesForSync(id string, timeStamp string) ([]*model.PointHistory, error) {
	...
	pointHistories, err := d.GetPointHistories(args.Args{IdGt: nstring.New(id)})
	if err != nil {
		return nil, err
	}
...
func (d *GormDatabase) DeletePointHistoriesByPointUUID(pUuid string, args args.Args) (bool, error) {
	var historyModel *model.PointHistory
	query := d.buildPointHistoryQuery(args)
