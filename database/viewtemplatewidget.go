...
func (d *GormDatabase) GetViewTemplateWidgets(args parentArgs.Args) ([]*model.ViewTemplateWidget, error) {
...
func (d *GormDatabase) GetViewTemplateWidget(uuid string, args parentArgs.Args) (*model.ViewTemplateWidget, error) {
...
func (d *GormDatabase) syncAfterUpdateViewTemplateWidget(uuid string) {
	viewTemplateWidget, err := d.GetViewTemplateWidget(uuid, parentArgs.Args{WithViewTemplateWidgetPointers: true})
	if err != nil {
		return
	}
	wg := &sync.WaitGroup{}
