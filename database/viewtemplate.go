...
func (d *GormDatabase) GetViewTemplates(args parentArgs.Args) ([]*model.ViewTemplate, error) {
...
func (d *GormDatabase) GetViewTemplate(uuid string, args parentArgs.Args) (*model.ViewTemplate, error) {
