// Package docs flow REST-API.
//
// This is the documentation of the flow REST-API.
//
// # Authentication
// In flow there are two token types:
...
//
// The token can be either transmitted through a header named `X-flow-Key` or a query parameter named `token`.
