...
const NetworksUrl string = "/api/networks"
const NetworkNameUrl string = "/api/networks/name"
const DeviceNameUrl string = "/api/devices/name"
const PointNameUrl string = "/api/points/name"
