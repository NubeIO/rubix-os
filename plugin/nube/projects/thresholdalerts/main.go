...
const path = "thresholdalerts" // must be unique across all plugins
const name = "thresholdalerts" // must be unique across all plugins
const description = "thresholdalerts plugin"
const author = "md"
...
const networkType = "thresholdalerts"
