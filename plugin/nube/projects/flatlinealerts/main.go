...
const path = "flatlinealerts" // must be unique across all plugins
const name = "flatlinealerts" // must be unique across all plugins
const description = "flatlinealerts plugin"
const author = "md"
...
const networkType = "flatlinealerts"
