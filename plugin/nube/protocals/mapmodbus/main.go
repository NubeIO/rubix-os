...
const path = "mapmodbus" // must be unique across all plugins
const name = "mapmodbus" // must be unique across all plugins
const description = "Maps Rubix Modbus Raw Service to FF"
const author = "md"
