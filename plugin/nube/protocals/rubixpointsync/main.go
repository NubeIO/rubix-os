...
const path = "rubixpointsync" // must be unique across all plugins
const name = "rubixpointsync" // must be unique across all plugins
const description = "Sync Flow Framework Points to Rubix Point Server"
const author = "md"
