...
import (
	...
	bacnetServerModel "github.com/NubeIO/flow-framework/plugin/nube/protocals/bacnetserver/model"
	model "github.com/NubeIO/flow-framework/plugin/nube/protocals/lorawan/model"
