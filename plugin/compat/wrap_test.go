...
func TestWrapIncompatiblePlugins(t *testing.T) {
	...
	for i, modulePath := range []string{
		"github.com/NubeDev/plug-framework/plugin/testing/broken/noinstance",
		"github.com/NubeDev/plug-framework/plugin/testing/broken/nothing",
		"github.com/NubeDev/plug-framework/plugin/testing/broken/unknowninfo",
		"github.com/NubeDev/plug-framework/plugin/testing/broken/malformedconstructor",
	} {
