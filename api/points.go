...
type PointDatabase interface {
	...
	CreatePoint(body *model.Point, publishPointList bool) (*model.Point, error)
	UpdatePoint(uuid string, body *model.Point, buffer bool) (*model.Point, error)
	...
	DeletePoint(uuid string, publishPointList bool) (bool, error)
